...
namespace CommandPalette {
    public static class CommandPalette {
        ...
        public static T GetSettings<T>(IPluginSettingsProvider<T> settingsProvider) where T : ScriptableObject => (T)PluginSettingsManager.GetSettings(settingsProvider);
    }
}