...
{
    public const string BUILD_VERSION = "2022.1.1f1";
    public const int VALUE_COUNT = 1911;
    public const string VALUE_COUNT_STRING = "1911";
...
#region Enumerations
    ...
    public enum Enum
    {
        ...
        buildsettings_qnx_on = 1444793783,
        buildsettings_qnx = 1987583715,
        buildsettings_qnx_small = 980843667,
        ...
        d_favorite_colored = 1835366482,
        d_favorite_hover = 1444592870,
        ...
        d_fullscreennotification = 489344853,
        d_gear = 305590136,
        ...
        d_groove = 1472319209,
        d_hierarchylock = 1867995095,
        d_horizontalsplit = 916152545,
        d_icon_dropdown_open = 363395447,
        ...
        d_texture2darray_on = 866405503,
        d_texture2darray = 494799503,
        d_toggle_searcher_preview_off = 132181310,
        d_toggle_searcher_preview_off_hover = 1453916073,
        d_toggle_searcher_preview_on = 1413656252,
        d_toggle_searcher_preview_on_hover = 2049049245,
        ...
        fullscreennotification = 2108578496,
        gear = 291593117,
        ...
        hierarchylock = 1144066066,
        horizontalsplit = 1277631650,
        icon_dropdown_open = 1760181994,
        ...
        packagebadgeoverride = 1195617993,
        ...
        link = 325350890,
        loading = 696727898,
        multiselectfeature = 392557819,
        package = 1040314106,
        refresh = 2053696097,
        update_available = 903211281,
        warning = 1860258274,
        installed_selected_focused = 559468890,
        ...
        d_materialvariant_icon = 762447015,
        ...
        materialvariant_icon = 1358472408,
        ...
        d_themestylesheet_icon = 1369115668,
        ...
        themestylesheet_icon = 1037662493,
        ...
        _2d_badge_scene_template = 1389480770,
        _3d_badge_scene_template = 649330589,
        pin = 339799447,
        pinned = 904956292,
        ...
        texture2darray_on = 1931012652,
        texture2darray = 941739844,
        toggle_searcher_preview_off = 1266508241,
        toggle_searcher_preview_on = 930758923,
    ...
    internal enum SortEnum
    {
        ...
        _menu = 3,
        _popup = 4,
        aboutwindow_mainheader = 5,
        ageialogo = 6,
        alphabeticalsorting = 7,
        anchortransformtool_on = 8,
        anchortransformtool = 9,
        animation_addevent = 10,
        animation_addkeyframe = 11,
        animation_eventmarker = 12,
        animation_filterbyselection = 13,
        animation_firstkey = 14,
        animation_lastkey = 15,
        animation_nextkey = 16,
        animation_play = 17,
        animation_prevkey = 18,
        animation_record = 19,
        animation_sequencerlink = 20,
        animationanimated = 21,
        animationdopesheetkeyframe = 22,
        animationkeyframe = 23,
        animationnocurve = 24,
        animationvisibilitytoggleoff = 25,
        animationvisibilitytoggleon = 26,
        animationwrapmodemenu = 27,
        assemblylock = 28,
        asset_store = 29,
        unity_assetstore_originals_logo_white = 30,
        audio_mixer = 31,
        autolightbakingoff = 32,
        autolightbakingon = 33,
        avatarcompass = 34,
        avatarcontroller_layer = 35,
        avatarcontroller_layerhover = 36,
        avatarcontroller_layerselected = 37,
        bodypartpicker = 38,
        bodysilhouette = 39,
        dotfill = 40,
        dotframe = 41,
        ...
        headik = 45,
        headzoom = 46,
        headzoomsilhouette = 47,
        leftarm = 48,
        leftfeetik = 49,
        leftfingers = 50,
        leftfingersik = 51,
        lefthandzoom = 52,
        lefthandzoomsilhouette = 53,
        leftleg = 54,
        maskeditor_root = 55,
        rightarm = 56,
        rightfeetik = 57,
        ...
        blendsampler = 72,
        bluegroove = 73,
        buildsettings_android_on = 74,
        buildsettings_android = 75,
        buildsettings_android_small = 76,
        buildsettings_broadcom = 77,
        buildsettings_dedicatedserver_on = 78,
        buildsettings_dedicatedserver = 79,
        buildsettings_dedicatedserver_small = 80,
        buildsettings_editor = 81,
        buildsettings_editor_small = 82,
        buildsettings_embeddedlinux_on = 83,
        buildsettings_embeddedlinux = 84,
        buildsettings_embeddedlinux_small = 85,
        buildsettings_facebook_on = 86,
        buildsettings_facebook = 87,
        buildsettings_facebook_small = 88,
        buildsettings_flashplayer = 89,
        buildsettings_flashplayer_small = 90,
        buildsettings_gamecorescarlett_on = 91,
        buildsettings_gamecorescarlett = 92,
        buildsettings_gamecorescarlett_small = 93,
        buildsettings_gamecorexboxone_on = 94,
        buildsettings_gamecorexboxone = 95,
        buildsettings_gamecorexboxone_small = 96,
        buildsettings_iphone_on = 97,
        buildsettings_iphone = 98,
        buildsettings_iphone_small = 99,
        buildsettings_lumin_on = 100,
        buildsettings_lumin = 101,
        buildsettings_lumin_small = 102,
        buildsettings_metro_on = 103,
        buildsettings_metro = 104,
        buildsettings_metro_small = 105,
        buildsettings_n3ds_on = 106,
        buildsettings_n3ds = 107,
        buildsettings_n3ds_small = 108,
        buildsettings_ps4_on = 109,
        buildsettings_ps4 = 110,
        buildsettings_ps4_small = 111,
        buildsettings_ps5_on = 112,
        buildsettings_ps5 = 113,
        buildsettings_ps5_small = 114,
        buildsettings_psm = 115,
        buildsettings_psm_small = 116,
        buildsettings_psp2 = 117,
        buildsettings_psp2_small = 118,
        buildsettings_qnx_on = 119,
        buildsettings_qnx = 120,
        buildsettings_qnx_small = 121,
        buildsettings_selectedicon = 122,
        buildsettings_stadia_on = 123,
        buildsettings_stadia = 124,
        buildsettings_stadia_small = 125,
        buildsettings_standalone_on = 126,
        buildsettings_standalone = 127,
        buildsettings_standalone_small = 128,
        buildsettings_standalonebroadcom_small = 129,
        buildsettings_standalonegles20emu_small = 130,
        buildsettings_standaloneglesemu = 131,
        buildsettings_standaloneglesemu_small = 132,
        buildsettings_switch_on = 133,
        buildsettings_switch = 134,
        buildsettings_switch_small = 135,
        buildsettings_tvos_on = 136,
        buildsettings_tvos = 137,
        buildsettings_tvos_small = 138,
        buildsettings_web = 139,
        buildsettings_web_small = 140,
        buildsettings_webgl_on = 141,
        buildsettings_webgl = 142,
        buildsettings_webgl_small = 143,
        buildsettings_wp8 = 144,
        buildsettings_wp8_small = 145,
        buildsettings_xbox360 = 146,
        buildsettings_xbox360_small = 147,
        buildsettings_xboxone_on = 148,
        buildsettings_xboxone = 149,
        buildsettings_xboxone_small = 150,
        cacheserverconnected = 151,
        cacheserverdisabled = 152,
        cacheserverdisconnected = 153,
        checkerfloor = 154,
        clipboard = 155,
        clothinspector_painttool = 156,
        clothinspector_paintvalue = 157,
        clothinspector_selecttool = 158,
        clothinspector_settingstool = 159,
        clothinspector_viewvalue = 160,
        cloudconnect = 161,
        collab_build = 162,
        collab_buildfailed = 163,
        collab_buildsucceeded = 164,
        collab_fileadded = 165,
        collab_fileconflict = 166,
        collab_filedeleted = 167,
        collab_fileignored = 168,
        collab_filemoved = 169,
        collab_fileupdated = 170,
        collab_folderadded = 171,
        collab_folderconflict = 172,
        collab_folderdeleted = 173,
        collab_folderignored = 174,
        collab_foldermoved = 175,
        collab_folderupdated = 176,
        collab_nointernet = 177,
        collab = 178,
        collab_warning = 179,
        collabconflict = 180,
        collaberror = 181,
        ...
        collabpull = 185,
        collabpush = 186,
        colorpicker_colorcycle = 187,
        colorpicker_cyclecolor = 188,
        colorpicker_cycleslider = 189,
        colorpicker_slidercycle = 190,
        console_erroricon_inactive_sml = 191,
        console_erroricon = 192,
        console_erroricon_sml = 193,
        console_infoicon_inactive_sml = 194,
        console_infoicon = 195,
        console_infoicon_sml = 196,
        console_warnicon_inactive_sml = 197,
        console_warnicon = 198,
        console_warnicon_sml = 199,
        createaddnew = 200,
        crossicon = 201,
        curvekeyframe = 202,
        curvekeyframeselected = 203,
        curvekeyframeselectedoverlay = 204,
        curvekeyframesemiselectedoverlay = 205,
        curvekeyframeweighted = 206,
        customsorting = 207,
        customtool = 208,
        d__fullscreen = 209,
        d__help = 210,
        d__menu = 211,
        d__popup = 212,
        d_aboutwindow_mainheader = 213,
        d_ageialogo = 214,
        d_alphabeticalsorting = 215,
        d_anchortransformtool_on = 216,
        d_anchortransformtool = 217,
        d_animation_addevent = 218,
        d_animation_addkeyframe = 219,
        d_animation_eventmarker = 220,
        d_animation_filterbyselection = 221,
        d_animation_firstkey = 222,
        d_animation_lastkey = 223,
        d_animation_nextkey = 224,
        d_animation_play = 225,
        d_animation_prevkey = 226,
        d_animation_record = 227,
        d_animation_sequencerlink = 228,
        d_animationanimated = 229,
        d_animationkeyframe = 230,
        d_animationnocurve = 231,
        d_animationvisibilitytoggleoff = 232,
        d_animationvisibilitytoggleon = 233,
        d_animationwrapmodemenu = 234,
        d_as_badge_delete = 235,
        d_as_badge_new = 236,
        d_assemblylock = 237,
        d_asset_store = 238,
        d_audio_mixer = 239,
        d_autolightbakingoff = 240,
        d_autolightbakingon = 241,
        d_avatarblendbackground = 242,
        d_avatarblendleft = 243,
        d_avatarblendlefta = 244,
        d_avatarblendright = 245,
        d_avatarblendrighta = 246,
        d_avatarcompass = 247,
        d_avatarpivot = 248,
        d_avatarselector = 249,
        d_back = 250,
        d_beginbutton_on = 251,
        d_beginbutton = 252,
        d_bluegroove = 253,
        d_buildsettings_android = 254,
        d_buildsettings_android_small = 255,
        d_buildsettings_broadcom = 256,
        d_buildsettings_dedicatedserver = 257,
        d_buildsettings_dedicatedserver_small = 258,
        d_buildsettings_facebook = 259,
        d_buildsettings_facebook_small = 260,
        d_buildsettings_flashplayer = 261,
        d_buildsettings_flashplayer_small = 262,
        d_buildsettings_gamecorescarlett = 263,
        d_buildsettings_gamecorescarlett_small = 264,
        d_buildsettings_gamecorexboxone = 265,
        d_buildsettings_gamecorexboxone_small = 266,
        d_buildsettings_iphone = 267,
        d_buildsettings_iphone_small = 268,
        d_buildsettings_lumin = 269,
        d_buildsettings_lumin_small = 270,
        d_buildsettings_metro = 271,
        d_buildsettings_metro_small = 272,
        d_buildsettings_n3ds = 273,
        d_buildsettings_n3ds_small = 274,
        d_buildsettings_ps4 = 275,
        d_buildsettings_ps4_small = 276,
        d_buildsettings_ps5 = 277,
        d_buildsettings_ps5_small = 278,
        d_buildsettings_psp2 = 279,
        d_buildsettings_psp2_small = 280,
        d_buildsettings_selectedicon = 281,
        d_buildsettings_stadia = 282,
        d_buildsettings_stadia_small = 283,
        d_buildsettings_standalone = 284,
        d_buildsettings_standalone_small = 285,
        d_buildsettings_switch = 286,
        d_buildsettings_switch_small = 287,
        d_buildsettings_tvos = 288,
        d_buildsettings_tvos_small = 289,
        d_buildsettings_web = 290,
        d_buildsettings_web_small = 291,
        d_buildsettings_webgl = 292,
        d_buildsettings_webgl_small = 293,
        d_buildsettings_xbox360 = 294,
        d_buildsettings_xbox360_small = 295,
        d_buildsettings_xboxone = 296,
        d_buildsettings_xboxone_small = 297,
        d_buildsettings_xiaomi = 298,
        d_buildsettings_xiaomi_small = 299,
        d_cacheserverconnected = 300,
        d_cacheserverdisabled = 301,
        d_cacheserverdisconnected = 302,
        d_checkerfloor = 303,
        d_cloudconnect = 304,
        d_collab_fileadded = 305,
        d_collab_fileconflict = 306,
        d_collab_filedeleted = 307,
        d_collab_fileignored = 308,
        d_collab_filemoved = 309,
        d_collab_fileupdated = 310,
        d_collab_folderadded = 311,
        d_collab_folderconflict = 312,
        d_collab_folderdeleted = 313,
        d_collab_folderignored = 314,
        d_collab_foldermoved = 315,
        d_collab_folderupdated = 316,
        d_collab = 317,
        d_colorpicker_cyclecolor = 318,
        d_colorpicker_cycleslider = 319,
        d_console_erroricon_inactive_sml = 320,
        d_console_erroricon = 321,
        d_console_erroricon_sml = 322,
        d_console_infoicon_inactive_sml = 323,
        d_console_infoicon = 324,
        d_console_infoicon_sml = 325,
        d_console_warnicon_inactive_sml = 326,
        d_console_warnicon = 327,
        d_console_warnicon_sml = 328,
        d_createaddnew = 329,
        d_curvekeyframe = 330,
        d_curvekeyframeselected = 331,
        d_curvekeyframeselectedoverlay = 332,
        d_curvekeyframesemiselectedoverlay = 333,
        d_curvekeyframeweighted = 334,
        d_customsorting = 335,
        d_customtool = 336,
        d_debuggerattached = 337,
        d_debuggerdisabled = 338,
        d_debuggerenabled = 339,
        d_defaultsorting = 340,
        d_editcollider = 341,
        d_editcollision_16 = 342,
        d_editcollision_32 = 343,
        d_editconstraints_16 = 344,
        d_editconstraints_32 = 345,
        d_editicon_sml = 346,
        d_endbutton_on = 347,
        d_endbutton = 348,
        d_exposure = 349,
        d_eyedropper_large = 350,
        d_eyedropper_sml = 351,
        d_favorite = 352,
        d_favorite_colored = 353,
        d_favorite_hover = 354,
        d_filterbylabel = 355,
        d_filterbytype = 356,
        d_filterselectedonly = 357,
        d_forward = 358,
        d_framecapture = 359,
        d_fullscreennotification = 360,
        d_gear = 361,
        d_gizmostoggle_on = 362,
        d_gizmostoggle = 363,
        d_grid_boxtool = 364,
        d_grid_default = 365,
        d_grid_erasertool = 366,
        d_grid_filltool = 367,
        d_grid_movetool = 368,
        d_grid_painttool = 369,
        d_grid_pickingtool = 370,
        d_groove = 371,
        d_hierarchylock = 372,
        d_horizontalsplit = 373,
        d_icon_dropdown_open = 374,
        d_icon_dropdown = 375,
        d_import = 376,
        d_inspectorlock = 377,
        d_invalid = 378,
        d_jointangularlimits = 379,
        d_leftbracket = 380,
        d_lighting = 381,
        d_lightmapeditor_windowtitle = 382,
        d_linked = 383,
        d_mainstageview = 384,
        d_mirror = 385,
        d_model_large = 386,
        ...
        d_navigation = 391,
        d_occlusion = 392,
        d_package_manager = 393,
        d_particle_effect = 394,
        d_particleshapetool_on = 395,
        d_particleshapetool = 396,
        d_pausebutton_on = 397,
        d_pausebutton = 398,
        d_playbutton_on = 399,
        d_playbutton = 400,
        d_playbuttonprofile_on = 401,
        d_playbuttonprofile = 402,
        d_playloopoff = 403,
        d_playloopon = 404,
        d_preaudioautoplayoff = 405,
        d_preaudioautoplayon = 406,
        d_preaudioloopoff = 407,
        d_preaudioloopon = 408,
        d_preaudioplayoff = 409,
        d_preaudioplayon = 410,
        d_prematcube = 411,
        d_prematcylinder = 412,
        d_prematlight0 = 413,
        d_prematlight1 = 414,
        d_prematquad = 415,
        d_prematsphere = 416,
        d_premattorus = 417,
        d_preset_context = 418,
        d_preset_current = 419,
        d_pretexa = 420,
        d_pretexb = 421,
        d_pretexg = 422,
        d_pretexr = 423,
        d_pretexrgb = 424,
        d_pretexturealpha = 425,
        d_pretexturemipmaphigh = 426,
        d_pretexturemipmaplow = 427,
        d_pretexturergb = 428,
        d_profiler_assetloading = 429,
        d_profiler_audio = 430,
        d_profiler_cpu = 431,
        d_profiler_custom = 432,
        d_profiler_fileaccess = 433,
        d_profiler_firstframe = 434,
        d_profiler_globalillumination = 435,
        d_profiler_gpu = 436,
        d_profiler_lastframe = 437,
        d_profiler_memory = 438,
        d_profiler_network = 439,
        d_profiler_networkmessages = 440,
        d_profiler_networkoperations = 441,
        d_profiler_nextframe = 442,
        d_profiler_open = 443,
        d_profiler_physics = 444,
        d_profiler_physics2d = 445,
        d_profiler_prevframe = 446,
        d_profiler_record = 447,
        d_profiler_rendering = 448,
        d_profiler_ui = 449,
        d_profiler_uidetails = 450,
        d_profiler_video = 451,
        d_profiler_virtualtexturing = 452,
        d_profilercolumn_warningcount = 453,
        d_progress = 454,
        d_project = 455,
        d_record_off = 456,
        d_record_on = 457,
        d_recttool_on = 458,
        d_recttool = 459,
        d_recttransformblueprint = 460,
        d_recttransformraw = 461,
        d_redgroove = 462,
        d_reflectionprobeselector = 463,
        d_refresh = 464,
        d_rightbracket = 465,
        d_rotatetool_on = 466,
        d_rotatetool = 467,
        ...
        d_scaletool = 470,
        d_scene = 471,
        d_scenepicking_notpickable_mixed = 472,
        d_scenepicking_notpickable_mixed_hover = 473,
        d_scenepicking_notpickable = 474,
        d_scenepicking_notpickable_hover = 475,
        d_scenepicking_pickable_mixed = 476,
        d_scenepicking_pickable_mixed_hover = 477,
        d_scenepicking_pickable = 478,
        d_scenepicking_pickable_hover = 479,
        d_sceneview2d_on = 480,
        d_sceneview2d = 481,
        d_sceneviewalpha = 482,
        d_sceneviewaudio_on = 483,
        d_sceneviewaudio = 484,
        d_sceneviewcamera = 485,
        d_sceneviewfx_on = 486,
        d_sceneviewfx = 487,
        d_sceneviewlighting_on = 488,
        d_sceneviewlighting = 489,
        d_sceneviewortho = 490,
        d_sceneviewrgb = 491,
        d_sceneviewtools = 492,
        d_sceneviewvisibility_on = 493,
        d_sceneviewvisibility = 494,
        d_scenevis_hidden_mixed = 495,
        d_scenevis_hidden_mixed_hover = 496,
        d_scenevis_hidden = 497,
        d_scenevis_hidden_hover = 498,
        d_scenevis_scene_hover = 499,
        d_scenevis_visible_mixed = 500,
        d_scenevis_visible_mixed_hover = 501,
        d_scenevis_visible = 502,
        d_scenevis_visible_hover = 503,
        d_scrollshadow = 504,
        d_settings = 505,
        d_settingsicon = 506,
        d_showpanels = 507,
        d_socialnetworks_facebookshare = 508,
        d_socialnetworks_linkedinshare = 509,
        d_socialnetworks_tweet = 510,
        d_socialnetworks_udnopen = 511,
        d_speedscale = 512,
        d_stepbutton_on = 513,
        d_stepbutton = 514,
        d_stepleftbutton_on = 515,
        d_stepleftbutton = 516,
        d_tab_next = 517,
        d_tab_prev = 518,
        d_terraininspector_terraintooladd = 519,
        d_terraininspector_terraintoollower_on = 520,
        d_terraininspector_terraintoolloweralt = 521,
        d_terraininspector_terraintoolplants_on = 522,
        d_terraininspector_terraintoolplants = 523,
        d_terraininspector_terraintoolplantsalt_on = 524,
        d_terraininspector_terraintoolplantsalt = 525,
        d_terraininspector_terraintoolraise_on = 526,
        d_terraininspector_terraintoolraise = 527,
        d_terraininspector_terraintoolsetheight_on = 528,
        d_terraininspector_terraintoolsetheight = 529,
        d_terraininspector_terraintoolsetheightalt_on = 530,
        d_terraininspector_terraintoolsetheightalt = 531,
        d_terraininspector_terraintoolsettings_on = 532,
        d_terraininspector_terraintoolsettings = 533,
        d_terraininspector_terraintoolsmoothheight_on = 534,
        d_terraininspector_terraintoolsmoothheight = 535,
        d_terraininspector_terraintoolsplat_on = 536,
        d_terraininspector_terraintoolsplat = 537,
        d_terraininspector_terraintoolsplatalt_on = 538,
        d_terraininspector_terraintoolsplatalt = 539,
        d_terraininspector_terraintooltrees_on = 540,
        d_terraininspector_terraintooltrees = 541,
        d_terraininspector_terraintooltreesalt_on = 542,
        d_terraininspector_terraintooltreesalt = 543,
        d_texture2darray_on = 544,
        d_texture2darray = 545,
        d_toggle_searcher_preview_off = 546,
        d_toggle_searcher_preview_off_hover = 547,
        d_toggle_searcher_preview_on = 548,
        d_toggle_searcher_preview_on_hover = 549,
        d_toggleuvoverlay = 550,
        d_toolbar_minus = 551,
        d_toolbar_plus_more = 552,
        d_toolbar_plus = 553,
        d_toolhandlecenter = 554,
        d_toolhandleglobal = 555,
        d_toolhandlelocal = 556,
        d_toolhandlepivot = 557,
        d_toolsicon = 558,
        d_tranp = 559,
        d_transformtool_on = 560,
        d_transformtool = 561,
        d_tree_icon = 562,
        d_tree_icon_branch = 563,
        d_tree_icon_branch_frond = 564,
        d_tree_icon_frond = 565,
        d_tree_icon_leaf = 566,
        d_treeeditor_addbranches = 567,
        d_treeeditor_addleaves = 568,
        d_treeeditor_branch_on = 569,
        d_treeeditor_branch = 570,
        d_treeeditor_branchfreehand_on = 571,
        d_treeeditor_branchfreehand = 572,
        d_treeeditor_branchrotate_on = 573,
        d_treeeditor_branchrotate = 574,
        d_treeeditor_branchscale_on = 575,
        d_treeeditor_branchscale = 576,
        d_treeeditor_branchtranslate_on = 577,
        d_treeeditor_branchtranslate = 578,
        d_treeeditor_distribution_on = 579,
        d_treeeditor_distribution = 580,
        d_treeeditor_duplicate = 581,
        d_treeeditor_geometry_on = 582,
        d_treeeditor_geometry = 583,
        d_treeeditor_leaf_on = 584,
        d_treeeditor_leaf = 585,
        d_treeeditor_leaffreehand_on = 586,
        d_treeeditor_leaffreehand = 587,
        d_treeeditor_leafrotate_on = 588,
        d_treeeditor_leafrotate = 589,
        d_treeeditor_leafscale_on = 590,
        d_treeeditor_leafscale = 591,
        d_treeeditor_leaftranslate_on = 592,
        d_treeeditor_leaftranslate = 593,
        d_treeeditor_material_on = 594,
        d_treeeditor_material = 595,
        d_treeeditor_refresh = 596,
        d_treeeditor_trash = 597,
        d_treeeditor_wind_on = 598,
        d_treeeditor_wind = 599,
        d_undohistory = 600,
        d_unityeditor_animationwindow = 601,
        d_unityeditor_consolewindow = 602,
        d_unityeditor_debuginspectorwindow = 603,
        d_unityeditor_devicesimulation_simulatorwindow = 604,
        d_unityeditor_finddependencies = 605,
        d_unityeditor_gameview = 606,
        d_unityeditor_graphs_animatorcontrollertool = 607,
        d_unityeditor_hierarchywindow = 608,
        d_unityeditor_historywindow = 609,
        d_unityeditor_inspectorwindow = 610,
        d_unityeditor_profilerwindow = 611,
        d_unityeditor_scenehierarchywindow = 612,
        d_unityeditor_sceneview = 613,
        d_unityeditor_timeline_timelinewindow = 614,
        d_unityeditor_versioncontrol = 615,
        d_unitylogo = 616,
        d_unlinked = 617,
        d_valid = 618,
        d_verticalsplit = 619,
        d_viewtoolmove_on = 620,
        d_viewtoolmove = 621,
        d_viewtoolorbit_on = 622,
        d_viewtoolorbit = 623,
        d_viewtoolzoom_on = 624,
        d_viewtoolzoom = 625,
        d_visibilityoff = 626,
        d_visibilityon = 627,
        d_vumetertexturehorizontal = 628,
        d_vumetertexturevertical = 629,
        d_waitspin00 = 630,
        d_waitspin01 = 631,
        d_waitspin02 = 632,
        d_waitspin03 = 633,
        ...
        d_waitspin10 = 640,
        d_waitspin11 = 641,
        d_welcomescreen_assetstorelogo = 642,
        d_winbtn_graph = 643,
        d_winbtn_graph_close_h = 644,
        d_winbtn_graph_max_h = 645,
        d_winbtn_graph_min_h = 646,
        d_winbtn_mac_close = 647,
        d_winbtn_mac_close_a = 648,
        d_winbtn_mac_close_h = 649,
        d_winbtn_mac_inact = 650,
        d_winbtn_mac_max = 651,
        d_winbtn_mac_max_a = 652,
        d_winbtn_mac_max_h = 653,
        d_winbtn_mac_min = 654,
        d_winbtn_mac_min_a = 655,
        d_winbtn_mac_min_h = 656,
        d_winbtn_win_close = 657,
        d_winbtn_win_close_a = 658,
        d_winbtn_win_close_h = 659,
        d_winbtn_win_max = 660,
        d_winbtn_win_max_a = 661,
        d_winbtn_win_max_h = 662,
        d_winbtn_win_min = 663,
        d_winbtn_win_min_a = 664,
        d_winbtn_win_min_h = 665,
        d_winbtn_win_rest = 666,
        d_winbtn_win_rest_a = 667,
        d_winbtn_win_rest_h = 668,
        d_winbtn_win_restore = 669,
        d_winbtn_win_restore_a = 670,
        d_winbtn_win_restore_h = 671,
        debuggerattached = 672,
        debuggerdisabled = 673,
        debuggerenabled = 674,
        defaultsorting = 675,
        editcollider = 676,
        editcollision_16 = 677,
        editcollision_32 = 678,
        editconstraints_16 = 679,
        editconstraints_32 = 680,
        editicon_sml = 681,
        endbutton_on = 682,
        endbutton = 683,
        exposure = 684,
        eyedropper_large = 685,
        eyedropper_sml = 686,
        favorite = 687,
        favorite_colored = 688,
        filterbylabel = 689,
        filterbytype = 690,
        filterselectedonly = 691,
        forward = 692,
        framecapture_on = 693,
        framecapture = 694,
        fullscreennotification = 695,
        gear = 696,
        gizmostoggle_on = 697,
        gizmostoggle = 698,
        grid_boxtool = 699,
        ...
        grid_movetool = 703,
        grid_painttool = 704,
        grid_pickingtool = 705,
        groove = 706,
        align_horizontally = 707,
        align_horizontally_center = 708,
        align_horizontally_center_active = 709,
        align_horizontally_left = 710,
        align_horizontally_left_active = 711,
        align_horizontally_right = 712,
        align_horizontally_right_active = 713,
        align_vertically = 714,
        align_vertically_bottom = 715,
        align_vertically_bottom_active = 716,
        align_vertically_center = 717,
        align_vertically_center_active = 718,
        align_vertically_top = 719,
        align_vertically_top_active = 720,
        d_align_horizontally = 721,
        d_align_horizontally_center = 722,
        d_align_horizontally_center_active = 723,
        d_align_horizontally_left = 724,
        d_align_horizontally_left_active = 725,
        d_align_horizontally_right = 726,
        d_align_horizontally_right_active = 727,
        d_align_vertically = 728,
        d_align_vertically_bottom = 729,
        d_align_vertically_bottom_active = 730,
        d_align_vertically_center = 731,
        d_align_vertically_center_active = 732,
        d_align_vertically_top = 733,
        d_align_vertically_top_active = 734,
        hierarchylock = 735,
        horizontalsplit = 736,
        icon_dropdown_open = 737,
        icon_dropdown = 738,
        import = 739,
        inspectorlock = 740,
        invalid = 741,
        jointangularlimits = 742,
        knobcshape = 743,
        knobcshapemini = 744,
        leftbracket = 745,
        lighting = 746,
        lightmapeditor_windowtitle = 747,
        lightmapping = 748,
        d_greenlight = 749,
        d_lightoff = 750,
        d_lightrim = 751,
        ...
        d_viewoptions = 779,
        gridandsnap = 780,
        grip_horizontalcontainer = 781,
        grip_verticalcontainer = 782,
        hoverbar_down = 783,
        hoverbar_leftright = 784,
        hoverbar_up = 785,
        locked = 786,
        orientationgizmo = 787,
        searchoverlay = 788,
        standardtools = 789,
        toolsettings = 790,
        toolstoggle = 791,
        ...
        package_manager = 794,
        packagebadgenew = 795,
        packagebadgeoverride = 796,
        feature_selected = 797,
        feature = 798,
        quickstart = 799,
        add_available = 800,
        custom = 801,
        customized = 802,
        download_available = 803,
        error = 804,
        folder = 805,
        git = 806,
        import_available = 807,
        info = 808,
        installed = 809,
        link = 810,
        loading = 811,
        multiselectfeature = 812,
        package = 813,
        refresh = 814,
        update_available = 815,
        warning = 816,
        installed_selected_focused = 817,
        particle_effect = 818,
        particleshapetool_on = 819,
        particleshapetool = 820,
        pausebutton_on = 821,
        pausebutton = 822,
        playbutton_on = 823,
        playbutton = 824,
        playbuttonprofile_on = 825,
        playbuttonprofile = 826,
        playloopoff = 827,
        playloopon = 828,
        playspeed = 829,
        preaudioautoplayoff = 830,
        preaudioautoplayon = 831,
        preaudioloopoff = 832,
        preaudioloopon = 833,
        preaudioplayoff = 834,
        preaudioplayon = 835,
        ...
        pretexrgb = 849,
        pretexturealpha = 850,
        pretexturearrayfirstslice = 851,
        pretexturearraylastslice = 852,
        pretexturemipmaphigh = 853,
        pretexturemipmaplow = 854,
        pretexturergb = 855,
        previewpackageinuse = 856,
        arealight_gizmo = 857,
        arealight_icon = 858,
        assembly_icon = 859,
        assetstore_icon = 860,
        audiomixerview_icon = 861,
        audiosource_gizmo = 862,
        boo_script_icon = 863,
        camera_gizmo = 864,
        chorusfilter_icon = 865,
        collabchanges_icon = 866,
        collabchangesconflict_icon = 867,
        collabchangesdeleted_icon = 868,
        collabconflict_icon = 869,
        collabcreate_icon = 870,
        collabdeleted_icon = 871,
        collabedit_icon = 872,
        collabexclude_icon = 873,
        collabmoved_icon = 874,
        cs_script_icon = 875,
        d_arealight_icon = 876,
        d_assembly_icon = 877,
        d_assetstore_icon = 878,
        d_audiomixerview_icon = 879,
        d_boo_script_icon = 880,
        d_collabchanges_icon = 881,
        d_collabchangesconflict_icon = 882,
        d_collabchangesdeleted_icon = 883,
        d_collabconflict_icon = 884,
        d_collabcreate_icon = 885,
        d_collabdeleted_icon = 886,
        d_collabedit_icon = 887,
        d_collabexclude_icon = 888,
        d_collabmoved_icon = 889,
        d_cs_script_icon = 890,
        d_directionallight_icon = 891,
        d_favorite_icon = 892,
        d_favorite_on_icon = 893,
        d_folder_icon = 894,
        d_folderempty_icon = 895,
        d_folderempty_on_icon = 896,
        d_folderfavorite_icon = 897,
        d_folderfavorite_on_icon = 898,
        d_folderopened_icon = 899,
        d_gridlayoutgroup_icon = 900,
        d_horizontallayoutgroup_icon = 901,
        d_js_script_icon = 902,
        d_lightingdataassetparent_icon = 903,
        d_materialvariant_icon = 904,
        d_microphone_icon = 905,
        d_prefab_icon = 906,
        d_prefab_on_icon = 907,
        d_prefabmodel_icon = 908,
        d_prefabmodel_on_icon = 909,
        d_prefabvariant_icon = 910,
        d_prefabvariant_on_icon = 911,
        d_raycastcollider_icon = 912,
        d_search_icon = 913,
        d_searchjump_icon = 914,
        d_settings_icon = 915,
        d_shortcut_icon = 916,
        d_spotlight_icon = 917,
        d_verticallayoutgroup_icon = 918,
        defaultslate_icon = 919,
        directionallight_gizmo = 920,
        directionallight_icon = 921,
        disclight_gizmo = 922,
        disclight_icon = 923,
        dll_script_icon = 924,
        echofilter_icon = 925,
        favorite_icon = 926,
        favorite_on_icon = 927,
        folder_icon = 928,
        folder_on_icon = 929,
        folderempty_icon = 930,
        folderempty_on_icon = 931,
        folderfavorite_icon = 932,
        folderfavorite_on_icon = 933,
        folderopened_icon = 934,
        folderopened_on_icon = 935,
        gamemanager_icon = 936,
        gridbrush_icon = 937,
        highpassfilter_icon = 938,
        horizontallayoutgroup_icon = 939,
        js_script_icon = 940,
        lensflare_gizmo = 941,
        lightingdataassetparent_icon = 942,
        lightprobegroup_gizmo = 943,
        lightprobeproxyvolume_gizmo = 944,
        lowpassfilter_icon = 945,
        main_light_gizmo = 946,
        materialvariant_icon = 947,
        metafile_icon = 948,
        microphone_icon = 949,
        muscleclip_icon = 950,
        particlesystem_gizmo = 951,
        particlesystemforcefield_gizmo = 952,
        pointlight_gizmo = 953,
        prefab_icon = 954,
        prefab_on_icon = 955,
        prefabmodel_icon = 956,
        prefabmodel_on_icon = 957,
        prefaboverlayadded_icon = 958,
        prefaboverlaymodified_icon = 959,
        prefaboverlayremoved_icon = 960,
        prefabvariant_icon = 961,
        prefabvariant_on_icon = 962,
        projector_gizmo = 963,
        raycastcollider_icon = 964,
        reflectionprobe_gizmo = 965,
        reverbfilter_icon = 966,
        sceneset_icon = 967,
        search_icon = 968,
        search_on_icon = 969,
        searchjump_icon = 970,
        settings_icon = 971,
        shortcut_icon = 972,
        softlockprojectbrowser_icon = 973,
        speedtreemodel_icon = 974,
        spotlight_gizmo = 975,
        spotlight_icon = 976,
        spritecollider_icon = 977,
        sv_icon_dot0_pix16_gizmo = 978,
        sv_icon_dot10_pix16_gizmo = 979,
        sv_icon_dot11_pix16_gizmo = 980,
        sv_icon_dot12_pix16_gizmo = 981,
        sv_icon_dot13_pix16_gizmo = 982,
        sv_icon_dot14_pix16_gizmo = 983,
        sv_icon_dot15_pix16_gizmo = 984,
        sv_icon_dot1_pix16_gizmo = 985,
        sv_icon_dot2_pix16_gizmo = 986,
        sv_icon_dot3_pix16_gizmo = 987,
        sv_icon_dot4_pix16_gizmo = 988,
        sv_icon_dot5_pix16_gizmo = 989,
        sv_icon_dot6_pix16_gizmo = 990,
        sv_icon_dot7_pix16_gizmo = 991,
        sv_icon_dot8_pix16_gizmo = 992,
        sv_icon_dot9_pix16_gizmo = 993,
        animatorcontroller_icon = 994,
        animatorcontroller_on_icon = 995,
        animatorstate_icon = 996,
        animatorstatemachine_icon = 997,
        animatorstatetransition_icon = 998,
        blendtree_icon = 999,
        d_animatorcontroller_icon = 1000,
        d_animatorcontroller_on_icon = 1001,
        d_animatorstate_icon = 1002,
        d_animatorstatemachine_icon = 1003,
        d_animatorstatetransition_icon = 1004,
        d_blendtree_icon = 1005,
        animationwindowevent_icon = 1006,
        audiomixercontroller_icon = 1007,
        audiomixercontroller_on_icon = 1008,
        d_audiomixercontroller_icon = 1009,
        d_audiomixercontroller_on_icon = 1010,
        audioimporter_icon = 1011,
        d_audioimporter_icon = 1012,
        d_defaultasset_icon = 1013,
        d_filter_icon = 1014,
        d_ihvimageformatimporter_icon = 1015,
        d_lightingdataasset_icon = 1016,
        d_lightmapparameters_icon = 1017,
        d_lightmapparameters_on_icon = 1018,
        d_modelimporter_icon = 1019,
        d_sceneasset_icon = 1020,
        d_shaderimporter_icon = 1021,
        d_shaderinclude_icon = 1022,
        d_textscriptimporter_icon = 1023,
        d_textureimporter_icon = 1024,
        d_truetypefontimporter_icon = 1025,
        defaultasset_icon = 1026,
        editorsettings_icon = 1027,
        filter_icon = 1028,
        anystatenode_icon = 1029,
        d_anystatenode_icon = 1030,
        humantemplate_icon = 1031,
        ihvimageformatimporter_icon = 1032,
        lightingdataasset_icon = 1033,
        lightmapparameters_icon = 1034,
        lightmapparameters_on_icon = 1035,
        modelimporter_icon = 1036,
        preset_icon = 1037,
        sceneasset_icon = 1038,
        sceneasset_on_icon = 1039,
        scenetemplateasset_icon = 1040,
        d_searchdatabase_icon = 1041,
        d_searchquery_icon = 1042,
        d_searchqueryasset_icon = 1043,
        searchdatabase_icon = 1044,
        searchquery_icon = 1045,
        searchqueryasset_icon = 1046,
        shaderimporter_icon = 1047,
        shaderinclude_icon = 1048,
        speedtreeimporter_icon = 1049,
        substancearchive_icon = 1050,
        textscriptimporter_icon = 1051,
        textureimporter_icon = 1052,
        truetypefontimporter_icon = 1053,
        d_spriteatlasasset_icon = 1054,
        d_spriteatlasimporter_icon = 1055,
        spriteatlasasset_icon = 1056,
        spriteatlasimporter_icon = 1057,
        d_visualeffectsubgraphblock_icon = 1058,
        d_visualeffectsubgraphoperator_icon = 1059,
        visualeffectsubgraphblock_icon = 1060,
        visualeffectsubgraphoperator_icon = 1061,
        videoclipimporter_icon = 1062,
        assemblydefinitionasset_icon = 1063,
        assemblydefinitionreferenceasset_icon = 1064,
        d_assemblydefinitionasset_icon = 1065,
        d_assemblydefinitionreferenceasset_icon = 1066,
        d_navmeshagent_icon = 1067,
        d_navmeshdata_icon = 1068,
        d_navmeshobstacle_icon = 1069,
        d_offmeshlink_icon = 1070,
        navmeshagent_icon = 1071,
        navmeshdata_icon = 1072,
        navmeshobstacle_icon = 1073,
        offmeshlink_icon = 1074,
        analyticstracker_icon = 1075,
        d_analyticstracker_icon = 1076,
        animation_icon = 1077,
        animationclip_icon = 1078,
        animationclip_on_icon = 1079,
        aimconstraint_icon = 1080,
        d_aimconstraint_icon = 1081,
        d_lookatconstraint_icon = 1082,
        d_parentconstraint_icon = 1083,
        d_positionconstraint_icon = 1084,
        d_rotationconstraint_icon = 1085,
        d_scaleconstraint_icon = 1086,
        lookatconstraint_icon = 1087,
        parentconstraint_icon = 1088,
        positionconstraint_icon = 1089,
        rotationconstraint_icon = 1090,
        scaleconstraint_icon = 1091,
        animator_icon = 1092,
        animatoroverridecontroller_icon = 1093,
        animatoroverridecontroller_on_icon = 1094,
        areaeffector2d_icon = 1095,
        articulationbody_icon = 1096,
        audiomixergroup_icon = 1097,
        audiomixersnapshot_icon = 1098,
        audiospatializermicrosoft_icon = 1099,
        d_audiomixergroup_icon = 1100,
        d_audiomixersnapshot_icon = 1101,
        d_audiospatializermicrosoft_icon = 1102,
        audiochorusfilter_icon = 1103,
        audioclip_icon = 1104,
        audioclip_on_icon = 1105,
        audiodistortionfilter_icon = 1106,
        audioechofilter_icon = 1107,
        audiohighpassfilter_icon = 1108,
        audiolistener_icon = 1109,
        audiolowpassfilter_icon = 1110,
        audioreverbfilter_icon = 1111,
        audioreverbzone_icon = 1112,
        audiosource_icon = 1113,
        avatar_icon = 1114,
        avatarmask_icon = 1115,
        avatarmask_on_icon = 1116,
        billboardasset_icon = 1117,
        billboardrenderer_icon = 1118,
        boxcollider_icon = 1119,
        boxcollider2d_icon = 1120,
        buoyancyeffector2d_icon = 1121,
        camera_icon = 1122,
        canvas_icon = 1123,
        canvasgroup_icon = 1124,
        canvasrenderer_icon = 1125,
        capsulecollider_icon = 1126,
        capsulecollider2d_icon = 1127,
        charactercontroller_icon = 1128,
        characterjoint_icon = 1129,
        circlecollider2d_icon = 1130,
        cloth_icon = 1131,
        compositecollider2d_icon = 1132,
        computeshader_icon = 1133,
        configurablejoint_icon = 1134,
        constantforce_icon = 1135,
        constantforce2d_icon = 1136,
        cubemap_icon = 1137,
        customcollider2d_icon = 1138,
        d_animation_icon = 1139,
        d_animationclip_icon = 1140,
        d_animationclip_on_icon = 1141,
        d_animator_icon = 1142,
        d_animatoroverridecontroller_icon = 1143,
        d_animatoroverridecontroller_on_icon = 1144,
        d_areaeffector2d_icon = 1145,
        d_articulationbody_icon = 1146,
        d_audiochorusfilter_icon = 1147,
        d_audioclip_icon = 1148,
        d_audioclip_on_icon = 1149,
        d_audiodistortionfilter_icon = 1150,
        d_audioechofilter_icon = 1151,
        d_audiohighpassfilter_icon = 1152,
        d_audiolistener_icon = 1153,
        d_audiolowpassfilter_icon = 1154,
        d_audioreverbfilter_icon = 1155,
        d_audioreverbzone_icon = 1156,
        d_audiosource_icon = 1157,
        d_avatar_icon = 1158,
        d_avatarmask_icon = 1159,
        d_avatarmask_on_icon = 1160,
        d_billboardasset_icon = 1161,
        d_billboardrenderer_icon = 1162,
        d_boxcollider_icon = 1163,
        d_boxcollider2d_icon = 1164,
        d_buoyancyeffector2d_icon = 1165,
        d_camera_icon = 1166,
        d_canvas_icon = 1167,
        d_canvasgroup_icon = 1168,
        d_canvasrenderer_icon = 1169,
        d_capsulecollider_icon = 1170,
        d_capsulecollider2d_icon = 1171,
        d_charactercontroller_icon = 1172,
        d_characterjoint_icon = 1173,
        d_circlecollider2d_icon = 1174,
        d_cloth_icon = 1175,
        d_compositecollider2d_icon = 1176,
        d_computeshader_icon = 1177,
        d_configurablejoint_icon = 1178,
        d_constantforce_icon = 1179,
        d_constantforce2d_icon = 1180,
        d_cubemap_icon = 1181,
        d_distancejoint2d_icon = 1182,
        d_edgecollider2d_icon = 1183,
        d_fixedjoint_icon = 1184,
        d_flare_icon = 1185,
        d_flare_on_icon = 1186,
        d_flarelayer_icon = 1187,
        d_font_icon = 1188,
        d_frictionjoint2d_icon = 1189,
        d_gameobject_icon = 1190,
        d_grid_icon = 1191,
        d_guiskin_icon = 1192,
        d_guiskin_on_icon = 1193,
        d_halo_icon = 1194,
        d_hingejoint_icon = 1195,
        d_hingejoint2d_icon = 1196,
        d_light_icon = 1197,
        d_lightingsettings_icon = 1198,
        d_lightprobegroup_icon = 1199,
        d_lightprobeproxyvolume_icon = 1200,
        d_lightprobes_icon = 1201,
        d_linerenderer_icon = 1202,
        d_lodgroup_icon = 1203,
        d_material_icon = 1204,
        d_material_on_icon = 1205,
        d_mesh_icon = 1206,
        d_meshcollider_icon = 1207,
        d_meshfilter_icon = 1208,
        d_meshrenderer_icon = 1209,
        d_motion_icon = 1210,
        d_occlusionarea_icon = 1211,
        d_occlusionportal_icon = 1212,
        d_particlesystem_icon = 1213,
        d_particlesystemforcefield_icon = 1214,
        d_physicmaterial_icon = 1215,
        d_physicmaterial_on_icon = 1216,
        d_physicsmaterial2d_icon = 1217,
        d_physicsmaterial2d_on_icon = 1218,
        d_platformeffector2d_icon = 1219,
        d_pointeffector2d_icon = 1220,
        d_polygoncollider2d_icon = 1221,
        d_proceduralmaterial_icon = 1222,
        d_projector_icon = 1223,
        d_raytracingshader_icon = 1224,
        d_recttransform_icon = 1225,
        d_reflectionprobe_icon = 1226,
        d_relativejoint2d_icon = 1227,
        d_rendertexture_icon = 1228,
        d_rendertexture_on_icon = 1229,
        d_rigidbody_icon = 1230,
        d_rigidbody2d_icon = 1231,
        d_scriptableobject_icon = 1232,
        d_scriptableobject_on_icon = 1233,
        d_shader_icon = 1234,
        d_shadervariantcollection_icon = 1235,
        d_skinnedmeshrenderer_icon = 1236,
        d_skybox_icon = 1237,
        d_sliderjoint2d_icon = 1238,
        d_spherecollider_icon = 1239,
        d_springjoint_icon = 1240,
        d_springjoint2d_icon = 1241,
        d_sprite_icon = 1242,
        d_spritemask_icon = 1243,
        d_spriterenderer_icon = 1244,
        d_streamingcontroller_icon = 1245,
        d_surfaceeffector2d_icon = 1246,
        d_targetjoint2d_icon = 1247,
        d_terrain_icon = 1248,
        d_terraincollider_icon = 1249,
        d_terraindata_icon = 1250,
        d_textasset_icon = 1251,
        d_texture_icon = 1252,
        d_texture2d_icon = 1253,
        d_trailrenderer_icon = 1254,
        d_transform_icon = 1255,
        d_wheelcollider_icon = 1256,
        d_wheeljoint2d_icon = 1257,
        d_windzone_icon = 1258,
        distancejoint2d_icon = 1259,
        edgecollider2d_icon = 1260,
        d_eventsystem_icon = 1261,
        d_eventtrigger_icon = 1262,
        d_hololensinputmodule_icon = 1263,
        d_physics2draycaster_icon = 1264,
        d_physicsraycaster_icon = 1265,
        d_standaloneinputmodule_icon = 1266,
        d_touchinputmodule_icon = 1267,
        eventsystem_icon = 1268,
        eventtrigger_icon = 1269,
        hololensinputmodule_icon = 1270,
        physics2draycaster_icon = 1271,
        physicsraycaster_icon = 1272,
        standaloneinputmodule_icon = 1273,
        touchinputmodule_icon = 1274,
        raytracingshader_icon = 1275,
        fixedjoint_icon = 1276,
        fixedjoint2d_icon = 1277,
        flare_icon = 1278,
        flare_on_icon = 1279,
        flarelayer_icon = 1280,
        font_icon = 1281,
        font_on_icon = 1282,
        frictionjoint2d_icon = 1283,
        gameobject_icon = 1284,
        gameobject_on_icon = 1285,
        grid_icon = 1286,
        guilayer_icon = 1287,
        guiskin_icon = 1288,
        guiskin_on_icon = 1289,
        guitext_icon = 1290,
        guitexture_icon = 1291,
        halo_icon = 1292,
        hingejoint_icon = 1293,
        hingejoint2d_icon = 1294,
        lensflare_icon = 1295,
        light_icon = 1296,
        lightingsettings_icon = 1297,
        lightprobegroup_icon = 1298,
        lightprobeproxyvolume_icon = 1299,
        lightprobes_icon = 1300,
        linerenderer_icon = 1301,
        lodgroup_icon = 1302,
        material_icon = 1303,
        material_on_icon = 1304,
        mesh_icon = 1305,
        meshcollider_icon = 1306,
        meshfilter_icon = 1307,
        meshrenderer_icon = 1308,
        motion_icon = 1309,
        movietexture_icon = 1310,
        d_networkanimator_icon = 1311,
        d_networkdiscovery_icon = 1312,
        d_networkidentity_icon = 1313,
        d_networklobbymanager_icon = 1314,
        d_networklobbyplayer_icon = 1315,
        d_networkmanager_icon = 1316,
        d_networkmanagerhud_icon = 1317,
        d_networkmigrationmanager_icon = 1318,
        d_networkproximitychecker_icon = 1319,
        d_networkstartposition_icon = 1320,
        d_networktransform_icon = 1321,
        d_networktransformchild_icon = 1322,
        d_networktransformvisualizer_icon = 1323,
        networkanimator_icon = 1324,
        networkdiscovery_icon = 1325,
        networkidentity_icon = 1326,
        networklobbymanager_icon = 1327,
        networklobbyplayer_icon = 1328,
        networkmanager_icon = 1329,
        networkmanagerhud_icon = 1330,
        networkmigrationmanager_icon = 1331,
        networkproximitychecker_icon = 1332,
        networkstartposition_icon = 1333,
        networktransform_icon = 1334,
        networktransformchild_icon = 1335,
        networktransformvisualizer_icon = 1336,
        networkview_icon = 1337,
        occlusionarea_icon = 1338,
        occlusionportal_icon = 1339,
        particlesystem_icon = 1340,
        particlesystemforcefield_icon = 1341,
        physicmaterial_icon = 1342,
        physicmaterial_on_icon = 1343,
        physicsmaterial2d_icon = 1344,
        physicsmaterial2d_on_icon = 1345,
        platformeffector2d_icon = 1346,
        d_playabledirector_icon = 1347,
        playabledirector_icon = 1348,
        pointeffector2d_icon = 1349,
        polygoncollider2d_icon = 1350,
        proceduralmaterial_icon = 1351,
        projector_icon = 1352,
        recttransform_icon = 1353,
        reflectionprobe_icon = 1354,
        relativejoint2d_icon = 1355,
        d_sortinggroup_icon = 1356,
        sortinggroup_icon = 1357,
        rendertexture_icon = 1358,
        rendertexture_on_icon = 1359,
        rigidbody_icon = 1360,
        rigidbody2d_icon = 1361,
        scriptableobject_icon = 1362,
        scriptableobject_on_icon = 1363,
        shader_icon = 1364,
        shadervariantcollection_icon = 1365,
        skinnedmeshrenderer_icon = 1366,
        skybox_icon = 1367,
        sliderjoint2d_icon = 1368,
        trackedposedriver_icon = 1369,
        spherecollider_icon = 1370,
        springjoint_icon = 1371,
        springjoint2d_icon = 1372,
        sprite_icon = 1373,
        spritemask_icon = 1374,
        spriterenderer_icon = 1375,
        streamingcontroller_icon = 1376,
        surfaceeffector2d_icon = 1377,
        targetjoint2d_icon = 1378,
        terrain_icon = 1379,
        terraincollider_icon = 1380,
        terraindata_icon = 1381,
        textasset_icon = 1382,
        textmesh_icon = 1383,
        texture_icon = 1384,
        texture2d_icon = 1385,
        d_tile_icon = 1386,
        d_tilemap_icon = 1387,
        d_tilemapcollider2d_icon = 1388,
        d_tilemaprenderer_icon = 1389,
        tile_icon = 1390,
        tilemap_icon = 1391,
        tilemapcollider2d_icon = 1392,
        tilemaprenderer_icon = 1393,
        d_signalasset_icon = 1394,
        d_signalemitter_icon = 1395,
        d_signalreceiver_icon = 1396,
        d_timelineasset_icon = 1397,
        d_timelineasset_on_icon = 1398,
        signalasset_icon = 1399,
        signalemitter_icon = 1400,
        signalreceiver_icon = 1401,
        timelineasset_icon = 1402,
        timelineasset_on_icon = 1403,
        trailrenderer_icon = 1404,
        transform_icon = 1405,
        tree_icon = 1406,
        d_spriteatlas_icon = 1407,
        d_spriteatlas_on_icon = 1408,
        d_spriteshaperenderer_icon = 1409,
        spriteatlas_icon = 1410,
        spriteatlas_on_icon = 1411,
        spriteshaperenderer_icon = 1412,
        aspectratiofitter_icon = 1413,
        button_icon = 1414,
        canvasscaler_icon = 1415,
        contentsizefitter_icon = 1416,
        d_aspectratiofitter_icon = 1417,
        d_button_icon = 1418,
        d_canvasscaler_icon = 1419,
        d_contentsizefitter_icon = 1420,
        d_dropdown_icon = 1421,
        d_freeformlayoutgroup_icon = 1422,
        d_graphicraycaster_icon = 1423,
        d_image_icon = 1424,
        d_inputfield_icon = 1425,
        d_layoutelement_icon = 1426,
        d_mask_icon = 1427,
        d_outline_icon = 1428,
        d_physicalresolution_icon = 1429,
        d_positionasuv1_icon = 1430,
        d_rawimage_icon = 1431,
        d_rectmask2d_icon = 1432,
        d_scrollbar_icon = 1433,
        d_scrollrect_icon = 1434,
        d_scrollviewarea_icon = 1435,
        d_selectable_icon = 1436,
        d_selectionlist_icon = 1437,
        d_selectionlistitem_icon = 1438,
        d_selectionlisttemplate_icon = 1439,
        d_shadow_icon = 1440,
        d_slider_icon = 1441,
        d_text_icon = 1442,
        d_toggle_icon = 1443,
        d_togglegroup_icon = 1444,
        dropdown_icon = 1445,
        freeformlayoutgroup_icon = 1446,
        graphicraycaster_icon = 1447,
        gridlayoutgroup_icon = 1448,
        image_icon = 1449,
        inputfield_icon = 1450,
        layoutelement_icon = 1451,
        mask_icon = 1452,
        outline_icon = 1453,
        positionasuv1_icon = 1454,
        rawimage_icon = 1455,
        rectmask2d_icon = 1456,
        scrollbar_icon = 1457,
        scrollrect_icon = 1458,
        selectable_icon = 1459,
        shadow_icon = 1460,
        slider_icon = 1461,
        text_icon = 1462,
        toggle_icon = 1463,
        togglegroup_icon = 1464,
        verticallayoutgroup_icon = 1465,
        d_panelsettings_icon = 1466,
        d_panelsettings_on_icon = 1467,
        d_stylesheet_icon = 1468,
        d_themestylesheet_icon = 1469,
        d_uidocument_icon = 1470,
        d_visualtreeasset_icon = 1471,
        panelsettings_icon = 1472,
        panelsettings_on_icon = 1473,
        stylesheet_icon = 1474,
        themestylesheet_icon = 1475,
        uidocument_icon = 1476,
        visualtreeasset_icon = 1477,
        d_visualeffect_icon = 1478,
        d_visualeffectasset_icon = 1479,
        visualeffect_icon = 1480,
        visualeffectasset_icon = 1481,
        d_videoplayer_icon = 1482,
        videoclip_icon = 1483,
        videoplayer_icon = 1484,
        wheelcollider_icon = 1485,
        wheeljoint2d_icon = 1486,
        windzone_icon = 1487,
        d_spatialmappingcollider_icon = 1488,
        spatialmappingcollider_icon = 1489,
        spatialmappingrenderer_icon = 1490,
        ussscript_icon = 1491,
        uxmlscript_icon = 1492,
        videoeffect_icon = 1493,
        visualeffect_gizmo = 1494,
        windzone_gizmo = 1495,
        profiler_assetloading = 1496,
        profiler_audio = 1497,
        profiler_cpu = 1498,
        profiler_custom = 1499,
        profiler_fileaccess = 1500,
        profiler_firstframe = 1501,
        profiler_globalillumination = 1502,
        profiler_gpu = 1503,
        profiler_instrumentation = 1504,
        profiler_lastframe = 1505,
        profiler_memory = 1506,
        profiler_networkmessages = 1507,
        profiler_networkoperations = 1508,
        profiler_nextframe = 1509,
        profiler_open = 1510,
        profiler_physics = 1511,
        profiler_physics2d = 1512,
        profiler_prevframe = 1513,
        profiler_record = 1514,
        profiler_rendering = 1515,
        profiler_ui = 1516,
        profiler_uidetails = 1517,
        profiler_video = 1518,
        profiler_virtualtexturing = 1519,
        profilercolumn_warningcount = 1520,
        progress = 1521,
        project = 1522,
        d_dragarrow = 1523,
        d_gridview_on = 1524,
        ...
        recttool_on = 1551,
        recttool = 1552,
        recttransformblueprint = 1553,
        recttransformraw = 1554,
        redgroove = 1555,
        reflectionprobeselector = 1556,
        repaintdot = 1557,
        rightbracket = 1558,
        rotatetool_on = 1559,
        rotatetool = 1560,
        ...
        sceneloadin = 1568,
        sceneloadout = 1569,
        scenepicking_notpickable_mixed = 1570,
        scenepicking_notpickable_mixed_hover = 1571,
        scenepicking_notpickable = 1572,
        scenepicking_notpickable_hover = 1573,
        scenepicking_pickable_mixed = 1574,
        scenepicking_pickable_mixed_hover = 1575,
        scenepicking_pickable = 1576,
        scenepicking_pickable_hover = 1577,
        scenesave = 1578,
        scenesavegrey = 1579,
        _2d_badge_scene_template = 1580,
        _3d_badge_scene_template = 1581,
        pin = 1582,
        pinned = 1583,
        scene_template_2d_scene = 1584,
        scene_template_3d_scene = 1585,
        scene_template_dark = 1586,
        scene_template_default_scene = 1587,
        scene_template_empty_scene = 1588,
        scene_template_light = 1589,
        scene_template = 1590,
        sceneview2d_on = 1591,
        sceneview2d = 1592,
        sceneviewalpha = 1593,
        sceneviewaudio_on = 1594,
        sceneviewaudio = 1595,
        sceneviewcamera_on = 1596,
        sceneviewcamera = 1597,
        sceneviewfx_on = 1598,
        sceneviewfx = 1599,
        sceneviewlighting_on = 1600,
        sceneviewlighting = 1601,
        sceneviewortho = 1602,
        sceneviewrgb = 1603,
        sceneviewtools_on = 1604,
        sceneviewtools = 1605,
        sceneviewvisibility_on = 1606,
        sceneviewvisibility = 1607,
        scenevis_hidden_mixed = 1608,
        scenevis_hidden_mixed_hover = 1609,
        scenevis_hidden = 1610,
        scenevis_hidden_hover = 1611,
        scenevis_scene_hover = 1612,
        scenevis_visible_mixed = 1613,
        scenevis_visible_mixed_hover = 1614,
        scenevis_visible = 1615,
        scenevis_visible_hover = 1616,
        scrollshadow = 1617,
        settings = 1618,
        settingsicon = 1619,
        alertdialog = 1620,
        ...
        d_gridaxisz_on = 1627,
        d_gridaxisz = 1628,
        d_sceneviewsnap_on = 1629,
        d_sceneviewsnap = 1630,
        d_snapincrement = 1631,
        gridaxisx_on = 1632,
        gridaxisx = 1633,
        gridaxisy_on = 1634,
        gridaxisy = 1635,
        gridaxisz_on = 1636,
        gridaxisz = 1637,
        sceneviewsnap_on = 1638,
        sceneviewsnap = 1639,
        snapincrement = 1640,
        socialnetworks_facebookshare = 1641,
        socialnetworks_linkedinshare = 1642,
        socialnetworks_tweet = 1643,
        socialnetworks_udnlogo = 1644,
        socialnetworks_udnopen = 1645,
        softlockinline = 1646,
        speedscale = 1647,
        statemachineeditor_arrowtip = 1648,
        statemachineeditor_arrowtipselected = 1649,
        statemachineeditor_background = 1650,
        statemachineeditor_state = 1651,
        statemachineeditor_statehover = 1652,
        statemachineeditor_stateselected = 1653,
        statemachineeditor_statesub = 1654,
        statemachineeditor_statesubhover = 1655,
        statemachineeditor_statesubselected = 1656,
        statemachineeditor_upbutton = 1657,
        statemachineeditor_upbuttonhover = 1658,
        stepbutton_on = 1659,
        stepbutton = 1660,
        stepleftbutton_on = 1661,
        stepleftbutton = 1662,
        sv_icon_dot0_sml = 1663,
        sv_icon_dot10_sml = 1664,
        sv_icon_dot11_sml = 1665,
        sv_icon_dot12_sml = 1666,
        sv_icon_dot13_sml = 1667,
        sv_icon_dot14_sml = 1668,
        sv_icon_dot15_sml = 1669,
        sv_icon_dot1_sml = 1670,
        sv_icon_dot2_sml = 1671,
        sv_icon_dot3_sml = 1672,
        sv_icon_dot4_sml = 1673,
        sv_icon_dot5_sml = 1674,
        sv_icon_dot6_sml = 1675,
        sv_icon_dot7_sml = 1676,
        sv_icon_dot8_sml = 1677,
        sv_icon_dot9_sml = 1678,
        sv_icon_name0 = 1679,
        sv_icon_name1 = 1680,
        sv_icon_name2 = 1681,
        sv_icon_name3 = 1682,
        ...
        tab_prev = 1697,
        tabtofilter = 1698,
        terraininspector_terraintooladd = 1699,
        terraininspector_terraintoollower_on = 1700,
        terraininspector_terraintoollower = 1701,
        terraininspector_terraintoolloweralt = 1702,
        terraininspector_terraintoolplants_on = 1703,
        terraininspector_terraintoolplants = 1704,
        terraininspector_terraintoolplantsalt_on = 1705,
        terraininspector_terraintoolplantsalt = 1706,
        terraininspector_terraintoolraise_on = 1707,
        terraininspector_terraintoolraise = 1708,
        terraininspector_terraintoolsculpt_on = 1709,
        terraininspector_terraintoolsculpt = 1710,
        terraininspector_terraintoolsetheight_on = 1711,
        terraininspector_terraintoolsetheight = 1712,
        terraininspector_terraintoolsetheightalt_on = 1713,
        terraininspector_terraintoolsetheightalt = 1714,
        terraininspector_terraintoolsettings_on = 1715,
        terraininspector_terraintoolsettings = 1716,
        terraininspector_terraintoolsmoothheight_on = 1717,
        terraininspector_terraintoolsmoothheight = 1718,
        terraininspector_terraintoolsplat_on = 1719,
        terraininspector_terraintoolsplat = 1720,
        terraininspector_terraintoolsplatalt_on = 1721,
        terraininspector_terraintoolsplatalt = 1722,
        terraininspector_terraintooltrees_on = 1723,
        terraininspector_terraintooltrees = 1724,
        terraininspector_terraintooltreesalt_on = 1725,
        terraininspector_terraintooltreesalt = 1726,
        testfailed = 1727,
        testignored = 1728,
        testinconclusive = 1729,
        testnormal = 1730,
        testpassed = 1731,
        teststopwatch = 1732,
        texture2darray_on = 1733,
        texture2darray = 1734,
        toggle_searcher_preview_off = 1735,
        toggle_searcher_preview_on = 1736,
        toggleuvoverlay = 1737,
        toolbar_minus = 1738,
        toolbar_plus_more = 1739,
        toolbar_plus = 1740,
        d_debug = 1741,
        d_objectmode = 1742,
        d_sceneviewtools_on = 1743,
        d_shaded = 1744,
        d_shadedwireframe = 1745,
        d_wireframe = 1746,
        debug_on = 1747,
        debug = 1748,
        objectmode = 1749,
        shaded = 1750,
        shadedwireframe = 1751,
        wireframe = 1752,
        toolhandlecenter = 1753,
        toolhandleglobal = 1754,
        toolhandlelocal = 1755,
        toolhandlepivot = 1756,
        toolsicon = 1757,
        tranp = 1758,
        transformtool_on = 1759,
        transformtool = 1760,
        tree_icon_branch = 1761,
        tree_icon_branch_frond = 1762,
        tree_icon_frond = 1763,
        tree_icon_leaf = 1764,
        treeeditor_addbranches = 1765,
        treeeditor_addleaves = 1766,
        treeeditor_branch_on = 1767,
        treeeditor_branch = 1768,
        treeeditor_branchfreehand_on = 1769,
        treeeditor_branchfreehand = 1770,
        treeeditor_branchrotate_on = 1771,
        treeeditor_branchrotate = 1772,
        treeeditor_branchscale_on = 1773,
        treeeditor_branchscale = 1774,
        treeeditor_branchtranslate_on = 1775,
        treeeditor_branchtranslate = 1776,
        treeeditor_distribution_on = 1777,
        treeeditor_distribution = 1778,
        treeeditor_duplicate = 1779,
        treeeditor_geometry_on = 1780,
        treeeditor_geometry = 1781,
        treeeditor_leaf_on = 1782,
        treeeditor_leaf = 1783,
        treeeditor_leaffreehand_on = 1784,
        treeeditor_leaffreehand = 1785,
        treeeditor_leafrotate_on = 1786,
        treeeditor_leafrotate = 1787,
        treeeditor_leafscale_on = 1788,
        treeeditor_leafscale = 1789,
        treeeditor_leaftranslate_on = 1790,
        treeeditor_leaftranslate = 1791,
        treeeditor_material_on = 1792,
        treeeditor_material = 1793,
        treeeditor_refresh = 1794,
        treeeditor_trash = 1795,
        treeeditor_wind_on = 1796,
        treeeditor_wind = 1797,
        undohistory = 1798,
        unityeditor_animationwindow = 1799,
        unityeditor_consolewindow = 1800,
        unityeditor_debuginspectorwindow = 1801,
        unityeditor_devicesimulation_simulatorwindow = 1802,
        unityeditor_finddependencies = 1803,
        unityeditor_gameview = 1804,
        unityeditor_graphs_animatorcontrollertool = 1805,
        unityeditor_hierarchywindow = 1806,
        unityeditor_historywindow = 1807,
        unityeditor_inspectorwindow = 1808,
        unityeditor_profilerwindow = 1809,
        unityeditor_scenehierarchywindow = 1810,
        unityeditor_sceneview = 1811,
        unityeditor_timeline_timelinewindow = 1812,
        unityeditor_versioncontrol = 1813,
        unitylogo = 1814,
        unitylogolarge = 1815,
        unlinked = 1816,
        uparrow = 1817,
        valid = 1818,
        d_file = 1819,
        d_incoming_icon = 1820,
        d_p4_addedlocal = 1821,
        d_p4_addedremote = 1822,
        d_p4_blueleftparenthesis = 1823,
        d_p4_bluerightparenthesis = 1824,
        d_p4_checkoutlocal = 1825,
        d_p4_checkoutremote = 1826,
        d_p4_conflicted = 1827,
        d_p4_deletedlocal = 1828,
        d_p4_deletedremote = 1829,
        d_p4_local = 1830,
        d_p4_lockedlocal = 1831,
        d_p4_lockedremote = 1832,
        d_p4_offline = 1833,
        d_p4_outofsync = 1834,
        d_p4_redleftparenthesis = 1835,
        d_p4_redrightparenthesis = 1836,
        d_p4_updating = 1837,
        file = 1838,
        incoming_icon = 1839,
        incoming_on_icon = 1840,
        outgoing_icon = 1841,
        p4_addedlocal = 1842,
        p4_addedremote = 1843,
        p4_blueleftparenthesis = 1844,
        p4_bluerightparenthesis = 1845,
        p4_checkoutlocal = 1846,
        p4_checkoutremote = 1847,
        p4_conflicted = 1848,
        p4_deletedlocal = 1849,
        p4_deletedremote = 1850,
        p4_local = 1851,
        p4_lockedlocal = 1852,
        p4_lockedremote = 1853,
        p4_offline = 1854,
        p4_outofsync = 1855,
        p4_redleftparenthesis = 1856,
        p4_redrightparenthesis = 1857,
        p4_updating = 1858,
        verticalsplit = 1859,
        viewtoolmove_on = 1860,
        viewtoolmove = 1861,
        viewtoolorbit_on = 1862,
        viewtoolorbit = 1863,
        viewtoolzoom_on = 1864,
        viewtoolzoom = 1865,
        visibilityoff = 1866,
        visibilityon = 1867,
        vumetertexturehorizontal = 1868,
        vumetertexturevertical = 1869,
        waitspin00 = 1870,
        waitspin01 = 1871,
        waitspin02 = 1872,
        waitspin03 = 1873,
        ...
        waitspin10 = 1880,
        waitspin11 = 1881,
        welcomescreen_assetstorelogo = 1882,
        winbtn_graph = 1883,
        winbtn_graph_close_h = 1884,
        winbtn_graph_max_h = 1885,
        winbtn_graph_min_h = 1886,
        winbtn_mac_close = 1887,
        winbtn_mac_close_a = 1888,
        winbtn_mac_close_h = 1889,
        winbtn_mac_inact = 1890,
        winbtn_mac_max = 1891,
        winbtn_mac_max_a = 1892,
        winbtn_mac_max_h = 1893,
        winbtn_mac_min = 1894,
        winbtn_mac_min_a = 1895,
        winbtn_mac_min_h = 1896,
        winbtn_win_close = 1897,
        winbtn_win_close_a = 1898,
        winbtn_win_close_h = 1899,
        winbtn_win_max = 1900,
        winbtn_win_max_a = 1901,
        winbtn_win_max_h = 1902,
        winbtn_win_min = 1903,
        winbtn_win_min_a = 1904,
        winbtn_win_min_h = 1905,
        winbtn_win_rest = 1906,
        winbtn_win_rest_a = 1907,
        winbtn_win_rest_h = 1908,
        winbtn_win_restore = 1909,
        winbtn_win_restore_a = 1910,
        winbtn_win_restore_h = 1911,
...
#region Constants
    ...
    public const string _fullscreen = "_fullscreen";
    ...
    public const string d__fullscreen = "d__fullscreen";
    ...
    public const string d_fullscreennotification = "d_fullscreennotification";
...
#region Initialization
    ...
    static EditorGUIIcons()
    {
        ...
        _iconLookup.Add(Enum._fullscreen, _fullscreen);
        _reverseIconLookup.Add(_fullscreen, Enum._fullscreen);
        ...
        _iconLookup.Add(Enum.buildsettings_qnx_on, buildsettings_qnx_on);
        _reverseIconLookup.Add(buildsettings_qnx_on, Enum.buildsettings_qnx_on);
        _iconLookup.Add(Enum.buildsettings_qnx, buildsettings_qnx);
        _reverseIconLookup.Add(buildsettings_qnx, Enum.buildsettings_qnx);
        _iconLookup.Add(Enum.buildsettings_qnx_small, buildsettings_qnx_small);
        _reverseIconLookup.Add(buildsettings_qnx_small, Enum.buildsettings_qnx_small);
        ...
        _iconLookup.Add(Enum.d__fullscreen, d__fullscreen);
        _reverseIconLookup.Add(d__fullscreen, Enum.d__fullscreen);
        ...
        _iconLookup.Add(Enum.d_favorite_colored, d_favorite_colored);
        _reverseIconLookup.Add(d_favorite_colored, Enum.d_favorite_colored);
        _iconLookup.Add(Enum.d_favorite_hover, d_favorite_hover);
        _reverseIconLookup.Add(d_favorite_hover, Enum.d_favorite_hover);
        ...
        _iconLookup.Add(Enum.d_fullscreennotification, d_fullscreennotification);
        _reverseIconLookup.Add(d_fullscreennotification, Enum.d_fullscreennotification);
        ...
        _iconLookup.Add(Enum.d_hierarchylock, d_hierarchylock);
        _reverseIconLookup.Add(d_hierarchylock, Enum.d_hierarchylock);
        _iconLookup.Add(Enum.d_horizontalsplit, d_horizontalsplit);
        _reverseIconLookup.Add(d_horizontalsplit, Enum.d_horizontalsplit);
        _iconLookup.Add(Enum.d_icon_dropdown_open, d_icon_dropdown_open);
        _reverseIconLookup.Add(d_icon_dropdown_open, Enum.d_icon_dropdown_open);
        ...
        _iconLookup.Add(Enum.d_preset_current, d_preset_current);
        _reverseIconLookup.Add(d_preset_current, Enum.d_preset_current);
        ...
        _iconLookup.Add(Enum.d_profiler_assetloading, d_profiler_assetloading);
        _reverseIconLookup.Add(d_profiler_assetloading, Enum.d_profiler_assetloading);
        ...
        _iconLookup.Add(Enum.d_profiler_fileaccess, d_profiler_fileaccess);
        _reverseIconLookup.Add(d_profiler_fileaccess, Enum.d_profiler_fileaccess);
        ...
        _iconLookup.Add(Enum.d_texture2darray_on, d_texture2darray_on);
        _reverseIconLookup.Add(d_texture2darray_on, Enum.d_texture2darray_on);
        _iconLookup.Add(Enum.d_texture2darray, d_texture2darray);
        _reverseIconLookup.Add(d_texture2darray, Enum.d_texture2darray);
        _iconLookup.Add(Enum.d_toggle_searcher_preview_off, d_toggle_searcher_preview_off);
        _reverseIconLookup.Add(d_toggle_searcher_preview_off, Enum.d_toggle_searcher_preview_off);
        _iconLookup.Add(Enum.d_toggle_searcher_preview_off_hover, d_toggle_searcher_preview_off_hover);
        _reverseIconLookup.Add(d_toggle_searcher_preview_off_hover, Enum.d_toggle_searcher_preview_off_hover);
        _iconLookup.Add(Enum.d_toggle_searcher_preview_on, d_toggle_searcher_preview_on);
        _reverseIconLookup.Add(d_toggle_searcher_preview_on, Enum.d_toggle_searcher_preview_on);
        _iconLookup.Add(Enum.d_toggle_searcher_preview_on_hover, d_toggle_searcher_preview_on_hover);
        _reverseIconLookup.Add(d_toggle_searcher_preview_on_hover, Enum.d_toggle_searcher_preview_on_hover);
        ...
        _iconLookup.Add(Enum.favorite_colored, favorite_colored);
        _reverseIconLookup.Add(favorite_colored, Enum.favorite_colored);
        ...
        _iconLookup.Add(Enum.fullscreennotification, fullscreennotification);
        _reverseIconLookup.Add(fullscreennotification, Enum.fullscreennotification);
        ...
        _iconLookup.Add(Enum.hierarchylock, hierarchylock);
        _reverseIconLookup.Add(hierarchylock, Enum.hierarchylock);
        _iconLookup.Add(Enum.horizontalsplit, horizontalsplit);
        _reverseIconLookup.Add(horizontalsplit, Enum.horizontalsplit);
        _iconLookup.Add(Enum.icon_dropdown_open, icon_dropdown_open);
        _reverseIconLookup.Add(icon_dropdown_open, Enum.icon_dropdown_open);
        ...
        _iconLookup.Add(Enum.packagebadgeoverride, packagebadgeoverride);
        _reverseIconLookup.Add(packagebadgeoverride, Enum.packagebadgeoverride);
        ...
        _iconLookup.Add(Enum.folder, folder);
        _reverseIconLookup.Add(folder, Enum.folder);
        ...
        _iconLookup.Add(Enum.multiselectfeature, multiselectfeature);
        _reverseIconLookup.Add(multiselectfeature, Enum.multiselectfeature);
        _iconLookup.Add(Enum.package, package);
        _reverseIconLookup.Add(package, Enum.package);
        ...
        _iconLookup.Add(Enum.installed_selected_focused, installed_selected_focused);
        _reverseIconLookup.Add(installed_selected_focused, Enum.installed_selected_focused);
        ...
        _iconLookup.Add(Enum.preset_current, preset_current);
        _reverseIconLookup.Add(preset_current, Enum.preset_current);
        ...
        _iconLookup.Add(Enum.d_materialvariant_icon, d_materialvariant_icon);
        _reverseIconLookup.Add(d_materialvariant_icon, Enum.d_materialvariant_icon);
        ...
        _iconLookup.Add(Enum.materialvariant_icon, materialvariant_icon);
        _reverseIconLookup.Add(materialvariant_icon, Enum.materialvariant_icon);
        ...
        _iconLookup.Add(Enum.d_themestylesheet_icon, d_themestylesheet_icon);
        _reverseIconLookup.Add(d_themestylesheet_icon, Enum.d_themestylesheet_icon);
        ...
        _iconLookup.Add(Enum.themestylesheet_icon, themestylesheet_icon);
        _reverseIconLookup.Add(themestylesheet_icon, Enum.themestylesheet_icon);
        ...
        _iconLookup.Add(Enum.profiler_assetloading, profiler_assetloading);
        _reverseIconLookup.Add(profiler_assetloading, Enum.profiler_assetloading);
        ...
        _iconLookup.Add(Enum.profiler_fileaccess, profiler_fileaccess);
        _reverseIconLookup.Add(profiler_fileaccess, Enum.profiler_fileaccess);
        ...
        _iconLookup.Add(Enum._2d_badge_scene_template, _2d_badge_scene_template);
        _reverseIconLookup.Add(_2d_badge_scene_template, Enum._2d_badge_scene_template);
        _iconLookup.Add(Enum._3d_badge_scene_template, _3d_badge_scene_template);
        _reverseIconLookup.Add(_3d_badge_scene_template, Enum._3d_badge_scene_template);
        ...
        _iconLookup.Add(Enum.texture2darray_on, texture2darray_on);
        _reverseIconLookup.Add(texture2darray_on, Enum.texture2darray_on);
        _iconLookup.Add(Enum.texture2darray, texture2darray);
        _reverseIconLookup.Add(texture2darray, Enum.texture2darray);
        _iconLookup.Add(Enum.toggle_searcher_preview_off, toggle_searcher_preview_off);
        _reverseIconLookup.Add(toggle_searcher_preview_off, Enum.toggle_searcher_preview_off);
        _iconLookup.Add(Enum.toggle_searcher_preview_on, toggle_searcher_preview_on);
        _reverseIconLookup.Add(toggle_searcher_preview_on, Enum.toggle_searcher_preview_on);
